...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>Which is not a real vegetable? <br> A: Carrot <br> B: Brocolli <br> C: Apple</html>");
		question3 = new JLabel("<html>Which is not a real amimal? <br> A: Bunny <br> B: Dog <br> C: Dragon</html>");
		question4 = new JLabel("<html>Which is not real? <br> A: Aliens <br> B: Computers <br> C: Orange</html>");
	}
